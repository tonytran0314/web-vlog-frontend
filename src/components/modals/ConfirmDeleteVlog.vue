...
<template>
    <div class="p-8 rounded-2xl flex flex-col gap-12 bg-box">
        <div class="flex justify-between">
            <div class="text-2xl flex items-center">Xoá Vlog</div>
            <div 
                @click="modal.close"
        ...
        <p>Bạn có chắc muốn xoá vlog này không ?</p>
        <form @submit.prevent="vlog.remove(propsData.id)" class="flex justify-end gap-4">
